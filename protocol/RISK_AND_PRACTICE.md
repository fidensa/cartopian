...
A pack revised to the operational mini-skill contract declares its **operational mini-skill sections** as its content areas — intended outcome, applicability and exclusions, conditional principles, working process, decision gates, failure modes, evidence, examples, stopping behavior, and sources — and carries its approved domain coverage as `domain_coverage`, judged by semantic review inside those sections. `software-delivery`, `research-inquiry`, and `marketing-claim` are revised to that contract; the remaining packs keep their original topic areas until their own revisions land.
...
| `marketing-and-operations` | rejected as exemplar set | 3 | 179 | 46 | +6 | +2 | 20,480 |
...
| `all-five-shapes` | **is the delivery scope** | 5 | 447 | 114 | +274 | +70 | 57,344 |

...
- When the current-cycle `STANDARDS.md` declares standards that bind this assignment (style and formatting conventions, required development practices, mandated validation tooling), the applicable excerpt in a `## Project standards` section — deidentified, and never the whole document. Omit the section when none apply.

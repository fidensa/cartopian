...
the tool-generated `## Operator intent` prompt section. Only the operator
invokes `cartopian attest-intent`; it is deliberately absent from PM/assignee
MCP surfaces and role presets.
